...
description: Launch or reopen the session monitor overlay from Codex. Use when the user types $session-monitor, asks to start, open, show, or run the monitor, or wants the Claude/Codex session status overlay running.
---
